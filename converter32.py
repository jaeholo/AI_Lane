...
class Converter:
    def __init__(self, model="yolov8x.pt", w_out=32, h_out=32, batch_size=32, time_offset=0, start_ms=0,
                 input_video_directory="", output_array_directory="", output_array_directory_simple="", output_array_subdirectory="", resolution=360,
                 lanes=(780,625,575,540), trees=(395,1525), tilt=0.8):
        ...
        # 20th numbers [773, 640, 595, 567, 265, 1625] -0.2
        ...
        # 34 numbers [540, 575, 625, 780, 395, 1525] 0.8
        # 35 numbers [500, 538, 588, 738, 340, 1580] 0.8
    ...
    def generate_aerial_frame(self, detections, w_in):
        ...
        for box in detections:
            ...
            if car != 0:
                ...
                cv2.rectangle(frame, pt1, pt2, car, -1)
        frame = frame[0:self.__w_out,round(self.__w_out * self.__trees[0]/1920):round(self.__w_out * self.__trees[1]/1920)]
        frame = cv2.resize(frame,(self.__w_out,self.__w_out))
    ...
    def video_with_cars(self, video_name, lanes):
        ...
        cap = cv2.VideoCapture(input_video)
        # skip to 15 minutes
        # 30 frames\s, 30*15*60=27000
        cap.set(cv2.CAP_PROP_POS_FRAMES, 35000)
        ...
        # 003: 0.4
        # 48:-0.15
        tilt_angle_degrees = 0.4  # should be tested  0.3

        output_path = "reference34.mp4"
        ...
        with tqdm(total=num_frames) as pbar:
            while cap.isOpened():
                ...
                # 48 numbers [633, 667, 717, 860, 365, 1555] 0.4
                # cv2.line(tilted_frame, (0, 633), (1920, 633), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 667), (1920, 667), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 717), (1920, 717), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 860), (1920, 860), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (365, 0), (365, 1080), (255, 0, 0), 1)
                # cv2.line(tilted_frame, (1555, 0), (1555, 1080), (255, 0, 0), 1)
                # cv2.line(tilted_frame, (15, 709), (610, 709), (0, 0, 255), 1)
                # 9m=900 -> 6m=600 // 960-600=360 :: 960+600=1560

                # 24 numbers [688, 719, 758, 870, 390, 1530] 960 middle
                # cv2.line(tilted_frame, (0, 688), (1920, 688), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 719), (1920, 719), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 758), (1920, 758), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 870), (1920, 870), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (390, 0), (390, 1080), (255, 0, 0), 1)
                # cv2.line(tilted_frame, (1530, 0), (1530, 1080), (255, 0, 0), 1)
                # cv2.line(tilted_frame, (1200, 755), (1770, 755), (0, 0, 255), 1)

                # 34 numbers [540, 575, 625, 780, 395, 1525] 960 middle tilt=0.4
                cv2.line(tilted_frame, (0, 540), (1920, 540), (0, 255, 0), 1)
                cv2.line(tilted_frame, (0, 575), (1920, 575), (0, 255, 0), 1)
                cv2.line(tilted_frame, (0, 625), (1920, 625), (0, 255, 0), 1)
                cv2.line(tilted_frame, (0, 780), (1920, 780), (0, 255, 0), 1)
                cv2.line(tilted_frame, (395, 0), (395, 1080), (255, 0, 0), 1)
                cv2.line(tilted_frame, (1525, 0), (1525, 1080), (255, 0, 0), 1)
                cv2.line(tilted_frame, (350, 625), (915, 625), (0, 0, 255), 1)

                # 35 numbers [500, 536, 588, 740, 340, 1580] 960 middle tilt=0.75
                # cv2.line(tilted_frame, (0, 500), (1920, 500), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 538), (1920, 538), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 588), (1920, 588), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 738), (1920, 738), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (340, 0), (340, 1080), (255, 0, 0), 1)
                # cv2.line(tilted_frame, (1580, 0), (1580, 1080), (255, 0, 0), 1)
                # cv2.line(tilted_frame, (390, 585), (1010, 585), (0, 0, 255), 1)

                # 63 numbers [738, 770, 820, 950, 390, 1520] 960 middle tilt=0.8
                # cv2.line(tilted_frame, (0, 738), (1920, 738), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 770), (1920, 770), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 820), (1920, 820), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (0, 950), (1920, 950), (0, 255, 0), 1)
                # cv2.line(tilted_frame, (390, 0), (390, 1080), (255, 0, 0), 1)
                # cv2.line(tilted_frame, (1530, 0), (1530, 1080), (255, 0, 0), 1)
                # cv2.line(tilted_frame, (1080, 800), (1650, 800), (0, 0, 255), 1)
...
# conv = Converter(input_video_directory="F:/convert/13",
#                  output_array_directory="F:/res_bird64",
#                  output_array_directory_simple="F:\\res_simple64",
#                  batch_size=64,
#                  time_offset=-50513,
#                  w_out=64,
#                  h_out=64)

conv = Converter(input_video_directory="F:/convert/34",
                 output_array_directory="F:/34/res_bird",
                 output_array_directory_simple="F:/34/res_simple",
                 batch_size=64,
                 time_offset= -55423,
                 w_out=32,
                 h_out=32)
...
if __name__ == "__main__":
    conv.video_with_cars("DJI_20231122103312_0002_D.MP4", 0) #analyse video
